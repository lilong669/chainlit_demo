...
def get_tool_doc_list_table():
    ...
    retriever_tool = create_retriever_tool(
        ...
        description="""Input to this tool should be table comment in the user question, output is a comma separated list of uesd table name about the question in the database.
    """
    )
...
def get_tool_doc_table_schema():
    ...
    retriever_tool = create_retriever_tool(
        ...
        description="""Input to this tool should be used table name in the user question , output is a comma separated list of uesd tables about the question in the database.
    """
    )
...
custom_tool_list = [doc_list_table_tool]
